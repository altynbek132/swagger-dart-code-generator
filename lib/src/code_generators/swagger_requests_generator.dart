...
class SwaggerRequestsGenerator extends SwaggerGeneratorBase {
  ...
  bool _isBasicTypeRef(String ref, SwaggerRoot root) {
    final schemas = getAllReusableObjects(root);
  ...
  String? getReturnTypeFromSchema(
    SwaggerResponse swaggerResponse,
    String modelPostfix,
    SwaggerRoot root,
  ) {
    ...
    if (ref.isNotEmpty) {
      final allReusableObjects = getAllReusableObjects(root);
  ...
  Map<String, SwaggerSchema> getAllReusableObjects(SwaggerRoot root) {
  ...
  String? getReturnTypeFromOriginalRef(
    SwaggerResponse swaggerResponse,
    String modelPostfix,
  ) {
  ...
  String? getReturnTypeFromContent({
    ...
    if (schemaRef.isNotEmpty) {
      final allRefs = getAllReusableObjects(swaggerRoot);
  ...
  String getReturnTypeName({
    ...
    final type =
        getReturnTypeFromType(neededResponse, modelPostfix) ??
        getReturnTypeFromSchema(neededResponse, modelPostfix, swaggerRoot) ??
        getReturnTypeFromOriginalRef(neededResponse, modelPostfix) ??
        getReturnTypeFromContent(
