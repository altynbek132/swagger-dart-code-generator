      ...
      final result = SwaggerRequestsGenerator(
        GeneratorOptions(
          ...
          responseOverrideValueMap: [
            ResponseOverrideValueMap(method: 'get', url: '/cars/schemaRefBody', overriddenValue: 'String'),
            ResponseOverrideValueMap(method: '', url: '/cars/returnTypeTests', overriddenValue: 'int'),
          ],
        ),
      ).generate(swaggerRoot: root, className: 'CarsService', fileName: 'cars_service', allEnums: []);

      final result2 = SwaggerRequestsGenerator(
        GeneratorOptions(
          inputFolder: '',
          outputFolder: '',
          defaultHeaderValuesMap: [DefaultHeaderValueMap(defaultValue: '120', headerName: 'id')],
          includePaths: ['car'],
        ),
      ).generate(swaggerRoot: root, allEnums: [], className: 'CarsService', fileName: 'cars_service');
