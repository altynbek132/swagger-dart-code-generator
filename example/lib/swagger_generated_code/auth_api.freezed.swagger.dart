...
abstract class AuthSmsSendCodeDto with _$AuthSmsSendCodeDto {
  const factory AuthSmsSendCodeDto({
    ...
    @JsonKey(
      name: 'channel',
      toJson: authSmsSendCodeDtoChannelNullableToJson,
      fromJson: authSmsSendCodeDtoChannelChannelNullableFromJson,
    )
    enums.AuthSmsSendCodeDtoChannel? channel,
  }) = _AuthSmsSendCodeDto;
  ...
  static enums.AuthSmsSendCodeDtoChannel?
  authSmsSendCodeDtoChannelChannelNullableFromJson(Object? value) =>
      authSmsSendCodeDtoChannelNullableFromJson(
        value,
        enums.AuthSmsSendCodeDtoChannel.sms,
      );
}
...
String? authSmsSendCodeDtoChannelNullableToJson(
  enums.AuthSmsSendCodeDtoChannel? authSmsSendCodeDtoChannel,
) {
  return authSmsSendCodeDtoChannel?.value;
}

String? authSmsSendCodeDtoChannelToJson(
  enums.AuthSmsSendCodeDtoChannel authSmsSendCodeDtoChannel,
) {
  return authSmsSendCodeDtoChannel.value;
}

enums.AuthSmsSendCodeDtoChannel authSmsSendCodeDtoChannelFromJson(
  Object? authSmsSendCodeDtoChannel, [
  enums.AuthSmsSendCodeDtoChannel? defaultValue,
]) {
  return enums.AuthSmsSendCodeDtoChannel.values.firstWhereOrNull(
        (e) => e.value == authSmsSendCodeDtoChannel,
      ) ??
      defaultValue ??
      enums.AuthSmsSendCodeDtoChannel.swaggerGeneratedUnknown;
}

enums.AuthSmsSendCodeDtoChannel? authSmsSendCodeDtoChannelNullableFromJson(
  Object? authSmsSendCodeDtoChannel, [
  enums.AuthSmsSendCodeDtoChannel? defaultValue,
]) {
  if (authSmsSendCodeDtoChannel == null) {
    return null;
  }
  return enums.AuthSmsSendCodeDtoChannel.values.firstWhereOrNull(
        (e) => e.value == authSmsSendCodeDtoChannel,
...
String authSmsSendCodeDtoChannelExplodedListToJson(
  List<enums.AuthSmsSendCodeDtoChannel>? authSmsSendCodeDtoChannel,
) {
  return authSmsSendCodeDtoChannel?.map((e) => e.value!).join(',') ?? '';
}

List<String> authSmsSendCodeDtoChannelListToJson(
  List<enums.AuthSmsSendCodeDtoChannel>? authSmsSendCodeDtoChannel,
) {
  if (authSmsSendCodeDtoChannel == null) {
    return [];
  ...
  return authSmsSendCodeDtoChannel.map((e) => e.value!).toList();
}

List<enums.AuthSmsSendCodeDtoChannel> authSmsSendCodeDtoChannelListFromJson(
  List? authSmsSendCodeDtoChannel, [
  List<enums.AuthSmsSendCodeDtoChannel>? defaultValue,
]) {
  if (authSmsSendCodeDtoChannel == null) {
    return defaultValue ?? [];
  }

  return authSmsSendCodeDtoChannel
      .map((e) => authSmsSendCodeDtoChannelFromJson(e.toString()))
      .toList();
}

List<enums.AuthSmsSendCodeDtoChannel>?
authSmsSendCodeDtoChannelNullableListFromJson(
  List? authSmsSendCodeDtoChannel, [
  List<enums.AuthSmsSendCodeDtoChannel>? defaultValue,
]) {
  if (authSmsSendCodeDtoChannel == null) {
