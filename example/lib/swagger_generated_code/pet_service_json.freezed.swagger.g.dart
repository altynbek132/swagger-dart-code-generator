...
part of 'pet_service_json.freezed.swagger.dart';
...
_Order _$OrderFromJson(Map<String, dynamic> json) => _Order(
  ...
  shipDate: json['shipDate'] == null ? null : DateTime.parse(json['shipDate'] as String),
...
_Tag _$TagFromJson(Map<String, dynamic> json) => _Tag(id: (json['id'] as num?)?.toInt(), name: json['name'] as String?);

Map<String, dynamic> _$TagToJson(_Tag instance) => <String, dynamic>{'id': ?instance.id, 'name': ?instance.name};
...
Map<String, dynamic> _$ApiResponseToJson(_ApiResponse instance) => <String, dynamic>{
  'code': ?instance.code,
  'type': ?instance.type,
